...
## Command execution  _(HARD)_

Anything not listed defaults to **APPROVAL_REQUIRED**.
...
## Autonomy limits  _(HARD)_

- At most 8 steps in a workflow, 3 iterations per step.
...
- Workflows time out after 1800 seconds.
